	...
	return (
		<div>
			...
			{fields.map((item, index) => (
				<div key={item.id} className="Eformcontainer">
					...
					>
						...
						<option value="ก๊าซในเลือดแดงมีค่าปกติ PaO2">
							ก๊าซในเลือดแดงมีค่าปกติ PaO2
						</option>
						<option value="ก๊าซในเลือดแดงมีค่าปกติ PaCO2">
							ก๊าซในเลือดแดงมีค่าปกติ PaCO2
						</option>
			...
			<div className="btncontainer">
				...
				<div
					onClick={() => handleFormSubmit({ Edata: fields })}
					className="submitbtn"
				>
					Submit
				</div>
